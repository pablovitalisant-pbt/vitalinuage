...
describe('Slice 06: Remove allergy banner, show in header', () => {
    it('should not render allergy banner and should show allergies in header', async () => {
        render(
            <BrowserRouter>
                <PatientProfile />
            </BrowserRouter>
        ...
        expect(screen.queryByTestId('allergy-alert-banner')).not.toBeInTheDocument();
