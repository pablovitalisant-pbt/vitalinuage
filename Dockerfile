...
RUN apt-get update && apt-get install -y \
    ...
    libcairo2 libpango-1.0-0 libpangocairo-1.0-0 libgdk-pixbuf-2.0-0 libgobject-2.0-0 \
...
CMD export PYTHONPATH=$PYTHONPATH:/app && python backend/migrate_prod.py && uvicorn backend.main:app --host 0.0.0.0 --port 8080